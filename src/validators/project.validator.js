...
const create = [
  ...
  body('serialType').optional().isIn(['LHS', 'AHD', 'Others']).withMessage('Invalid serial type'),
  body('projectType').optional({ checkFalsy: true }).isIn(['Private', 'Contractor', 'NF Project']).withMessage('Invalid project type'),
